...
public class DemoSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        // add our users for in memory authentication; it can be replaced with DB authentication
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // to enter user name and password for each request. However, this is not always the case depending
        // on the REST client / browser
